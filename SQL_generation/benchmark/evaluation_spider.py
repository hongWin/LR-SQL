...
from eval_tools.process_sql import get_schema, Schema, get_sql
from eval_tools.exec_eval import eval_exec_match
...
if __name__ == "__main__":
    ...
    kmaps = None
    #  choices=('all', 'exec', 'match'))
    gold = './GOLD/Gold_Dataset2.txt'
    pred = './predict/Predicted_DB_GPT2.txt'


    db = './eval_data/database'
    table = './eval_data/tables.json'
    #  choices=('all', 'exec', 'match')
    etype = 'all'
    if etype in ['all', 'match']:
    ...
    evaluate(gold, pred, db, etype, kmaps, False, False, False)
